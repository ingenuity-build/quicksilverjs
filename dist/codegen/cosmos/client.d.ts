...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.staking.v1beta1.MsgTokenizeShares": {
        aminoType: string;
        toAmino: (message: import("./staking/v1beta1/lsm").MsgTokenizeShares) => import("./staking/v1beta1/lsm").MsgTokenizeSharesAmino;
        fromAmino: (object: import("./staking/v1beta1/lsm").MsgTokenizeSharesAmino) => import("./staking/v1beta1/lsm").MsgTokenizeShares;
    };
