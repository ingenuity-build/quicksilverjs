...
const createRPCMsgClient = async ({ rpc }) => ({
    ...
    quicksilver: {
        airdrop: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./airdrop/v1/messages.rpc.msg")))).MsgClientImpl(rpc)
        },
        interchainquery: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./interchainquery/v1/messages.rpc.msg")))).MsgClientImpl(rpc)
        },
        interchainstaking: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./interchainstaking/v1/messages.rpc.msg")))).MsgClientImpl(rpc)
        },
        participationrewards: {
            v1: new (await Promise.resolve().then(() => __importStar(require("./participationrewards/v1/messages.rpc.msg")))).MsgClientImpl(rpc)
        },
        tokenfactory: {
