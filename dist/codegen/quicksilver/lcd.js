...
const createLCDClient = async ({ restEndpoint }) => {
    ...
    return {
        ...
        quicksilver: {
            airdrop: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./airdrop/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            claimsmanager: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./claimsmanager/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            epochs: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./epochs/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            interchainstaking: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./interchainstaking/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            mint: {
            ...
            participationrewards: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./participationrewards/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            supply: {
                v1: new (await Promise.resolve().then(() => __importStar(require("./supply/v1/query.lcd")))).LCDQueryClient({
                    requestClient
                })
            },
            tokenfactory: {
