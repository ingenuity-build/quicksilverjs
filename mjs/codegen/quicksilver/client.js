...
export const quicksilverProtoRegistry = [...quicksilverAirdropV1MessagesRegistry.registry, ...quicksilverInterchainqueryV1MessagesRegistry.registry, ...quicksilverInterchainstakingV1MessagesRegistry.registry, ...quicksilverParticipationrewardsV1MessagesRegistry.registry, ...quicksilverTokenfactoryV1beta1TxRegistry.registry];
export const getSigningQuicksilverClientOptions = ({ defaultTypes = defaultRegistryTypes } = {}) => {
...
export const getSigningQuicksilverClient = async ({ rpcEndpoint, signer, defaultTypes = defaultRegistryTypes }) => {
    const { registry, aminoTypes } = getSigningQuicksilverClientOptions({
        defaultTypes
    });
